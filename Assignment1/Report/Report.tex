...
In \cref{tab:QTablePar2} I have provided one of the possible Q-matrices formed after 10000 rounds by one of the cars. This is of course highly variable and some cars end up with slightly negative values in places other than the last state that would end up to bridge collapse.
